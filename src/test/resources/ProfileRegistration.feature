Feature: ProfileRegistration
  ...
  Scenario: The data entered is valid
    ...
    When I want create a user with a post request to "/districts/4/profiles" with the following data required is valid for a organizer
    Then the response for this request should be a status code of 202

  Scenario: The data entered is valid
    Given I'm a musician and I have entered my data
    When I want create a user with a post request to "/districts/3/profiles" with the following data required is valid for a musician
    Then the response for this request should be a status code of 202
